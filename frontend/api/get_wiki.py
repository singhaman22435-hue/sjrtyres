...
print("Tractor:", get_wiki_image("Tractor"))
print("Dump truck:", get_wiki_image("Dump truck"))
print("Motorcycle:", get_wiki_image("Motorcycle"))
print("Semi-trailer truck:", get_wiki_image("Semi-trailer truck"))
